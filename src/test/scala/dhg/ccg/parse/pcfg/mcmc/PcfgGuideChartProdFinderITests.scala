...
class PcfgGuideChartProdFinderITests {
  ...
  @Test
  def x_test_SimplePcfgGuideChartProdFinder {
    ...
    val gcu = new SimplePcfgGuideChartProdFinderI()
    val (gcRoots, gcBinys, gcUnrys, gcTerms) = gcu.all(Array(guideChart1I, guideChart2I), numCats, numWords)
