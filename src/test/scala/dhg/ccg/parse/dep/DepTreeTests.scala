...
class DepTreeTests {
  ...
  def test_DepTree_fromCcgTree() {
    ...
    //    val d12 = DepTree.fromCcgTree(t12)
    ...
    //    val d11 = DepTree.fromCcgTree(t11)
    ...
    val d5 = DepTree.fromCcgTree(t5)
    //TreeViz.drawTree(d5)
    def rCheck(a: DepTree, b: DepTree) {
      a match {
     ...
     */
    {
      ...
      val d10 = DepTree.fromCcgTree(t10)
  ...
  @Test
  def test_DepTree_fromCcgTree_withUnary() {
